...
using Olivianet.Controller.WebApp.Stores;
using System;
using System.Security.Cryptography;
using System.Security.Cryptography.X509Certificates;
using Xunit;

namespace Olivianet.Controller.WebApp.IntegrationTests
{
    public class UnitTest1
    {
        ...
        {
            ICertificateStore certStore = new FileCertificateStore("");
            X509Certificate2 cert = certStore.Generate("Olivianet Tokens");
            certStore.Store(cert, "tokens.pfx");
        }
        ...
        {
            ICertificateStore certStore = new FileCertificateStore("");
            X509Certificate2 cert = certStore.Get("tokens.pfx");
